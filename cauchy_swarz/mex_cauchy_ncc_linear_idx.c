		 ...
		 )
{
    ...
    */
    ...
    plhs[5]= mxCreateNumericMatrix(1,box_num, mxDOUBLE_CLASS ,mxREAL);
    plhs[6]= mxCreateNumericMatrix(1,1, mxDOUBLE_CLASS ,mxREAL);
    
    int ind_num=cauchy_swarz_ncc(img,img_r,img_c,pat,n_p,m_p,norms_of_wins_minus_mu,wins_mu, box_arr, w_arr, box_num, threshold, residual_pat_norms,frac_for_direct,(int*)mxGetPr(plhs[1]),(int*)mxGetPr(plhs[2]),(REAL_TYPE*)mxGetPr(plhs[3]), (REAL_TYPE*)mxGetPr(plhs[0]),(int*)mxGetPr(plhs[4]),(double*)mxGetPr(plhs[5]),(double*)mxGetPr(plhs[6]));
    ...
    */
    ...
    plhs[3]= mxCreateNumericMatrix(1,box_num, mxINT32_CLASS ,mxREAL);
    plhs[4]= mxCreateNumericMatrix(1,box_num, mxDOUBLE_CLASS ,mxREAL);
    plhs[5]= mxCreateNumericMatrix(1,1, mxDOUBLE_CLASS ,mxREAL);
    
    int ind_num=cauchy_swarz_ncc_linear_idx(I,img,img_r,img_c,pat,n_p,m_p,norms_of_wins_minus_mu,wins_mu, box_arr, w_arr, box_num, threshold, residual_pat_norms,frac_for_direct,(int*)mxGetPr(plhs[1]),(REAL_TYPE*)mxGetPr(plhs[2]), (REAL_TYPE*)mxGetPr(plhs[0]),(int*)mxGetPr(plhs[3]),(double*)mxGetPr(plhs[4]),(double*)mxGetPr(plhs[5]));
