...
int linear_idx_norms_mu_U_before_loop_find(const REAL_TYPE* I,const REAL_TYPE* I2,int I_r,REAL_TYPE* U,int from_r,int to_r,int from_c,int to_c, REAL_TYPE w,REAL_TYPE* norms_of_wins_minus_mu,int img_r,int img_c,int n_p,int m_p,REAL_TYPE*  wins_mu,int* lidx,REAL_TYPE threshold){
    ...
    while(U_ptr<U_end){
        ...
        if(ci<c_r){
            ...
            // }
            //I_idx_col+=I_r;
            //            I_ul_ptr0 = I+I_idx_col;
            //I_ur_ptr0 = ur_const_term0+I_ul_ptr0;
            //I_bl_ptr0 = n_p+I_ul_ptr0;
            //I_br_ptr0 = br_const_term0+I_ul_ptr0;
            ...
            //I2_ul_ptr = I2+I_idx_col;
            //I2_ur_ptr = ur_const_term0+I2_ul_ptr;
            //I2_bl_ptr = n_p+I2_ul_ptr;
            //I2_br_ptr = br_const_term0+I2_ul_ptr;

            I2_ul_ptr+=(n_p+1);// = I2+I_idx_col;
            I2_ur_ptr+=(n_p+1);// = ur_const_term0+I2_ul_ptr;
            I2_bl_ptr+=(n_p+1);// = n_p+I2_ul_ptr;
            I2_br_ptr+=(n_p+1);// = br_const_term0+I2_ul_ptr;
            
            I_ul_ptr+=(n_p+1);// = ul_const_term+I_idx_col;
            I_ur_ptr+=(n_p+1);// = ur_const_term+I_idx_col;
            I_bl_ptr+=(n_p+1);// = bl_const_term+I_idx_col;
            I_br_ptr+=(n_p+1);// = br_const_term+I_idx_col;
